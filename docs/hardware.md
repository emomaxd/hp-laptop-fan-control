...
## Reported interface support

The following boards have been reported to expose the relevant interface, but
have not all been verified with hpfand.
...
Presence in this table is not a guarantee. Firmware revisions and sensor
layouts can differ between products sharing a family name.
